...
import { getSvgVariantCatalogByWordBucket, getSvgVariantCandidates, getSvgVariantExitProfile, getSvgVariantMotionProfile, getSvgSlotSchemaForWordCount, getSvgVariantsForSlotSchema, getSvgTypographyVariantFamily, getSvgTypographyVariant, getSvgTypographyVariantFromStyleKey, getSvgTypographyVariantIdFromStyleKey, selectSvgTypographyVariant, svgTypographyVariantsV1, toSvgTypographyStyleKey } from "../stylebooks/svg-typography-v1";
