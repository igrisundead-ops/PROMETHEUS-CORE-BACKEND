...
import { deterministicChunkWords, getChunkPolicyStats, mapWordChunksToCaptionChunks } from "../caption-chunker";
import { captionPolicy, isHardWordCountAllowed } from "../caption-policy";
import { getSvgTypographyVariantFamily, getSvgTypographyVariantFromStyleKey, getSvgSlotKeysForSchema, isBlurHeavySvgTypographyVariant, SVG_TYPOGRAPHY_STYLE_PREFIX } from "../stylebooks/svg-typography-v1";
const w = (text, startMs, endMs) => ({
    text,
    startMs,
    endMs
});
