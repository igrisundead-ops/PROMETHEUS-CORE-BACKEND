...
import captions from "../../data/captions.dean-graziosi.json";
import { rerouteSvgTypographyChunks, routeStyleForWords } from "../style-routing";
import { HORMOZI_WORD_LOCK_MOTION_KEY, HORMOZI_WORD_LOCK_STYLE_KEY } from "../stylebooks/hormozi-word-lock-v1";
import { getSvgVariantExitProfile, getSvgVariantMotionProfile, getSvgTypographyVariantFamily, getSvgTypographyVariantFromStyleKey, isSvgVariantLegacyOptIn, SVG_TYPOGRAPHY_STYLE_PREFIX } from "../stylebooks/svg-typography-v1";
...
describe("style routing", () => {
  ...
  it("routes variation name-callout chunks to the flat SLCP lane", () => {
    ...
    it("avoids blur-heavy, typing, stacked, sweep-heavy, and wipe-reveal svg families in the current Dean SVG routing pass", () => {
        const rerouted = rerouteSvgTypographyChunks(captions);
