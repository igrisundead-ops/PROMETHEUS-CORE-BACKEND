import type {CaptionLayoutVariant, CaptionStyleProfileId} from "../types";

export const HORMOZI_WORD_LOCK_PROFILE_ID: CaptionStyleProfileId = "hormozi_word_lock_v1";
...
export const HORMOZI_WORD_LOCK_LAYOUT_VARIANT: CaptionLayoutVariant = "inline";
...
export const clampWordTimingToFrame = ({
  startMs,
  endMs,
  fps
}: {
...
export const isHormoziWordLockStyleKey = (styleKey: string): boolean => {
