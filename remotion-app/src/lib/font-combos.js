...
export const listFontCombos = () => FONT_COMBOS.slice();
export const pickFontCombo = (seed) => {
...
export const getFontComboById = (id) => {
    if (!id) {
        return null;
    }
...
export const ACTIVE_FONT_COMBO = getFontComboById(overrideId) ?? pickFontCombo(comboSeed);
export const logActiveFontCombo = () => {
    ...
    root[globalKey] = true;
    console.info(`[FontCombo] Using "${ACTIVE_FONT_COMBO.label}" (id=${ACTIVE_FONT_COMBO.id}) ` +
