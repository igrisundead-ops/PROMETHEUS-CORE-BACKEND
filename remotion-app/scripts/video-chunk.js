...
const padChunkIndex = (index) => String(index).padStart(2, "0");

const readGeneratedChunkPaths = async (outDir, prefix) => {
...
const renameChunksToStableNames = async (outDir, prefix) => {
