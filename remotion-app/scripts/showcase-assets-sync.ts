...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200">
  ...
  <text x="600" y="555" fill="#f7fbff" font-family="Manrope, Arial, sans-serif" font-size="94" font-weight="800" letter-spacing="12" text-anchor="middle">${safeLabel}</text>
  <text x="600" y="670" fill="#8fb1ff" font-family="Manrope, Arial, sans-serif" font-size="34" font-weight="700" letter-spacing="8" text-anchor="middle">${safeId}</text>
</svg>`;
};
